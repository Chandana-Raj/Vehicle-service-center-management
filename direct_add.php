...
<div class="formGroup">
    ...
    <span class='label' for='bphonenumber'>Contact number:</span>
        <input type='text' name='b_contact_no' id='bphonenumber' required autocomplete='off'>
        </div>
<div class="formGroup">
...
<?php  if(isset($_POST['directaddss'])) { ?>
<!DOCTYPE html>
<html lang='en'>
<head>
...
<div class="formGroup">
    ...
    <div class="formGroup">
    <span class='label' for='cphonenumber'>Contact number:</span>
...
<?php  if(isset($_POST['directaddsb'])) { ?>
<!DOCTYPE html>
<html lang='en'>
<head>
...
<?php  if(isset($_POST['directaddbi'])) { ?>
<!DOCTYPE html>
<html lang='en'>
<head>
